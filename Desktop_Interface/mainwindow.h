...
private slots:
	...
	void on_action31250_toggled(bool arg1);
	...
	void on_action31250_2_toggled(bool arg1);
...
private:
	...
	std::vector<uint8_t> resampler(
	    std::vector<uint8_t>, int input_baudRate, int output_baudRate);
